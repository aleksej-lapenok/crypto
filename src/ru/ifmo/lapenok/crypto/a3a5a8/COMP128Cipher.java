...
public class COMP128Cipher {
    ...
    public static void main(String[] args) {
        ...
        int[] inputBytes = trimInput(input);
        int[] keyBytes = trimInput(key);

        int[] encrypted = encrypt(inputBytes, keyBytes);
    ...
    private static int[] encrypt(int[] input, int[] key) {
        ...
        System.arraycopy(input, 0, x, 16, 16);
        for (int i = 0; i < 8; i++) {
            System.arraycopy(key, 0, x, 0, 16);
            for (int j = 0; j < 5; j++) {
                for (int k = 0; k < (1 << j); k++) {//подстановка
            ...
            for (int j = 0; j < 32; j++) {//образование бит из байт
                for (int k = 0; k < 4; k++) {
    ...
    private static int[] trimInput(String str) {
