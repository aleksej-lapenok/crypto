package ru.ifmo.lapenok.crypto.hash;

import javax.xml.bind.DatatypeConverter;
import java.nio.ByteBuffer;

public class Sha256 {
    static final int[] K = {0x428a2f98, 0x71374491, 0xb5c0fbcf,
    ...
    public static void main(String[] args) {
        String input = args[0];
        System.out.println(DatatypeConverter.printHexBinary(hash(input.getBytes())));
    }

    public static String hash(String message) {
        return DatatypeConverter.printHexBinary(hash(message.getBytes()));
    }
